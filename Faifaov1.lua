...
local SkidQuestBone =  CFrame.new(
    -9505.55371,
    172.448059,
    6086.27588,
    0.927873373,
        ...
        if AutoFarmBone then
            pcall(function()
                ...
                if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false then
                    if BypassTP then
                        wait()
                       if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - SkidQuestBone.Position).Magnitude > 2500 then
                       BTP(SkidQuestBone)
                       wait(0.2)
                       elseif (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - SkidQuestBone.Position).Magnitude < 2500 then
                       wait(0.4)
                       Tween(SkidQuestBone)
                       end
                 else
                ...
                if (SkidQuestBone.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 3 then    
